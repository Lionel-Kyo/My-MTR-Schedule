...
final List<MtrStation> lightRailStations = [
  ...
  MtrStation(id: 40, code: "040", name: const LocalizedString("Tuen Mun Swimming Pool", "屯門泳池")),
  MtrStation(id: 50, code: "050", name: const LocalizedString("Goodview Garden", "豐景園")),
  MtrStation(id: 60, code: "060", name: const LocalizedString("Siu Hei", "兆禧")),
  ...
  MtrStation(id: 110, code: "110", name: const LocalizedString("Tsing Wun", "青雲")),
  MtrStation(id: 120, code: "120", name: const LocalizedString("Kin On", "建安")),
  ...
  MtrStation(id: 240, code: "240", name: const LocalizedString("Siu Lun", "兆麟")),
  MtrStation(id: 250, code: "250", name: const LocalizedString("On Ting", "安定")),
  MtrStation(id: 260, code: "260", name: const LocalizedString("Yau Oi", "友愛")),
  MtrStation(id: 265, code: "265", name: const LocalizedString("Hoh Fuk Tong", "何福堂")),
  MtrStation(id: 270, code: "270", name: const LocalizedString("Pui To", "杯渡")),
  MtrStation(id: 275, code: "275", name: const LocalizedString("Prime View", "景峰")),
  ...
  MtrStation(id: 300, code: "300", name: const LocalizedString("San Hui", "新墟")),
  MtrStation(id: 310, code: "310", name: const LocalizedString("Kei Lun", "麒麟")),
  MtrStation(id: 320, code: "320", name: const LocalizedString("Fung Tei", "鳳地")),
  MtrStation(id: 330, code: "330", name: const LocalizedString("Lam Tei", "藍地")),
  MtrStation(id: 340, code: "340", name: const LocalizedString("Nai Wai", "泥圍")),
  MtrStation(id: 350, code: "350", name: const LocalizedString("Chung Uk Tsuen", "鍾屋村")),
  
  MtrStation(id: 360, code: "360", name: const LocalizedString("Hung Shui Kiu", "洪水橋")),
  MtrStation(id: 370, code: "370", name: const LocalizedString("Ping Shan", "屏山")),
  MtrStation(id: 380, code: "380", name: const LocalizedString("Tong Fong Tsuen", "塘坊村")),
